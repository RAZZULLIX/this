...
int main(int argc, char **argv)
{
    ...
    for (uint32_t pos = 0; pos < file_size; ++pos) {
        ...
        for (int bit_idx = 7; bit_idx >= 0; --bit_idx) {
            ...
            F[18] = H(18, c1, B1, B2) ^ H(110, B4, B8, 0) ^ H(1100, B12, B16, 0);
            F[19] = H(19, c1, mb1, 0);
            F[20] = H(20, c1, mb2, 0);
            F[21] = H(21, c1, mb1, B1);
            F[22] = H(22, c1, mb2, B1);
            ...
            F[51] = H(51, c1, B11, B12) ^ H(488, B13, B14, 0);
            ...
            F[131] = H(131, c1, B1, B8) ^ H(1588, B16, 0, 0);
            F[132] = H(132, c1, B2, B9) ^ H(1599, B17, 0, 0);
